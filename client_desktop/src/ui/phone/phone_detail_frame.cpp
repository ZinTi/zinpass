...
void PhoneDetailFrame::list_telecom_operators() const {
    ...
    zinpass::rpc::TelecomRPC telecom_rpc(zinpass::state::ChannelManager::instance().get_channel());
...
void PhoneDetailFrame::fetch_phone_by_id(const int id) const {
    ...
    // 2. 查询数据
    zinpass::rpc::PhoneRPC phone_rpc(zinpass::state::ChannelManager::instance().get_channel());
