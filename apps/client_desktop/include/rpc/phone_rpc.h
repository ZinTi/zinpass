...
public:
     ...
     * @return
     */
    Return<std::vector<zinpass::MobilePhone>> list_phones(const std::string& session_id, const std::string& telecom, const std::string& phone_number);
     ...
     * @return
     */
    Return<zinpass::MobilePhone> find_phone_by_id(const std::string& session_id, int phone_id);
