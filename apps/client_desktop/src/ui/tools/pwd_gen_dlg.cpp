...
void PwdGenDlg::initLayout(){
    lyt_main_ = new QVBoxLayout(this);
    lyt_header_ = new QHBoxLayout;
    lyt_body_ = new QHBoxLayout;
    lyt_footer_ = new QHBoxLayout;
    lyt_setting_ = new QVBoxLayout;
    lyt_edit_ = new QFormLayout;
