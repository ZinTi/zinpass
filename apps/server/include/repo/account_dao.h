...
public:
	 ...
	 * @return 状态码
     */
    DaoStatus findById(const std::string& id, zinpass::ViewAccount& view_account) const;
	 ...
	 * @return 状态码
	 */
	DaoStatus find(const std::string& sys_user_id, std::vector<zinpass::ViewAccount>& view_accounts) const;
	 ...
	 * @return 成功与否
	 */
	[[nodiscard]] DaoStatus add(const zinpass::Account& account) const;
     ...
     * @return 成功与否
     */
    [[nodiscard]] DaoStatus add(const zinpass::ViewAccount& view_account) const;
     ...
     * @return 成功与否
     */
    [[nodiscard]] DaoStatus update(const zinpass::ViewAccount& view_account) const;
	 ...
	 * @return 成功与否
	 */
	[[nodiscard]] DaoStatus update_main_properties(const zinpass::ViewAccount& view_account) const;
     ...
     * @return 成功与否
     */
    DaoStatus findEmailById(const std::string& id, zinpass::ViewAccount& email) const;
	 ...
	 * @return 成功与否
	 */
	DaoStatus findEmail(const std::string& sys_user_id, std::vector<zinpass::ViewAccount>& emails) const;
...
private:
	 ...
	 * @return 账号记录视图
	 */
	static zinpass::ViewAccount ViewAccountFromStatement(sqlite3_stmt* stmt);
