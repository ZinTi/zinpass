...
if [ "${os_name}" == "ubuntu-latest" ] && [ "${c_compiler}" == "gcc" ]; then
  ...
  curl -L --retry 3 -O https://github.com/ZinTi/cpp-prebuilt-libs/releases/download/yaml-cpp/yaml-cpp-v0.8.0-20251021-linux-x86_64-gcc.tar.xz
  curl -L --retry 3 -O https://github.com/ZinTi/cpp-prebuilt-libs/releases/download/boost/boost-v1.89.0-20251021-linux-x86_64-gcc.tar.xz
  curl -L --retry 3 -O https://github.com/ZinTi/cpp-prebuilt-libs/releases/download/qt/qt-release-6.10.0-20251024-linux-x86_64-gcc.tar.xz
  ...
  tar -xf yaml-cpp-v0.8.0-20251021-linux-x86_64-gcc.tar.xz -C "${workspace_dir}/third_party/"
  tar -xf boost-v1.89.0-20251021-linux-x86_64-gcc.tar.xz -C "${workspace_dir}/third_party/"
  tar -xf qt-release-6.10.0-20251024-linux-x86_64-gcc.tar.xz -C "${workspace_dir}/third_party/"
  ...
  curl -L --retry 3 -O https://github.com/ZinTi/cpp-prebuilt-libs/releases/download/yaml-cpp/yaml-cpp-v0.8.0-20251021-linux-x86_64-clang.tar.xz
  curl -L --retry 3 -O https://github.com/ZinTi/cpp-prebuilt-libs/releases/download/boost/boost-v1.89.0-20251021-linux-x86_64-clang.tar.xz
  ...
  tar -xf yaml-cpp-v0.8.0-20251021-linux-x86_64-clang.tar.xz -C "${workspace_dir}/third_party/"
  tar -xf boost-v1.89.0-20251021-linux-x86_64-clang.tar.xz -C "${workspace_dir}/third_party/"
  ...
  curl -L --retry 3 -O https://github.com/ZinTi/cpp-prebuilt-libs/releases/download/yaml-cpp/yaml-cpp-v0.8.0-20251021-windows-x86_64-msvc.7z
  curl -L --retry 3 -O https://github.com/ZinTi/cpp-prebuilt-libs/releases/download/boost/boost-v1.89.0-20251021-windows-x86_64-msvc.7z
  ...
  7z x yaml-cpp-v0.8.0-20251021-windows-x86_64-msvc.7z -o"${workspace_dir}/third_party/"
  7z x boost-v1.89.0-20251021-windows-x86_64-msvc.7z -o"${workspace_dir}/third_party/"
  ...
  curl -L --retry 3 -O https://github.com/ZinTi/cpp-prebuilt-libs/releases/download/yaml-cpp/yaml-cpp-v0.8.0-20251021-windows-x86_64-mingw.7z
  curl -L --retry 3 -O https://github.com/ZinTi/cpp-prebuilt-libs/releases/download/boost/boost-v1.89.0-20251021-windows-x86_64-msys2.7z
  ...
  7z x yaml-cpp-v0.8.0-20251021-windows-x86_64-mingw.7z -o"${workspace_dir}/third_party/"
  7z x boost-v1.89.0-20251021-windows-x86_64-msys2.7z -o"${workspace_dir}/third_party/"
