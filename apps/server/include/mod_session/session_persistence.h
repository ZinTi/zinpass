...
public:
     ...
     * @return 成功与否
     */
    static bool add(const zinpass::Session &session);
     ...
     * @return 会话数据
     */
    static zinpass::Session load_session(const std::string& session_id);
     ...
     * @return 所有会话数据
     */
    static std::vector<zinpass::Session> list_all_sessions();
