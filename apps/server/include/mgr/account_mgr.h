...
public:
     ...
     */
    static Return<std::vector<zinpass::ViewAccount>> get_accounts(
     ...
     */
    static Return<zinpass::ViewAccount> get_account_by_id(const std::string& account_id);
     ...
     * @return 成功与否 + message
     */
    static Return<bool> update_account(const zinpass::ViewAccount& view_account,const std::string& plaintext_pwd,const std::string& main_key);
     ...
     * @return 成功与否 + message
     */
    static Return<bool> update_account_base_info(const zinpass::ViewAccount& view_account);
