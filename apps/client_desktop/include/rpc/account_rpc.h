...
public:
     ...
     */
    Return<zinpass::ViewAccount> list_account_by_id(const std::string& session_id, const std::string& account_id);
     ...
     */
    Return<std::vector<zinpass::ViewAccount>> list_accounts(
        const std::string& session_id,
        const std::string& provider_name,
        const std::string& platform_name,
        const std::string& username,
