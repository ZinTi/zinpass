...
namespace zinpass::utils {
    ...
    // 日期增减实现
    std::string DateTime::addDays(const std::string& dateStr, const int days, const char* fmt_in, const char* fmt_out) {
        std::tm tm = {};
    ...
    std::string DateTime::addMonths(const std::string& dateStr, const int months, const char* fmt_in, const char* fmt_out) {
        std::tm tm = {};
        std::istringstream ss(dateStr);
        ss >> std::get_time(&tm, fmt_in);
        if (ss.fail()) return "";
    ...
    std::string DateTime::addYears(const std::string& dateStr, const int years, const char* fmt_in, const char* fmt_out) {
        std::tm tm = {};
        std::istringstream ss(dateStr);
        ss >> std::get_time(&tm, fmt_in);
        if (ss.fail()) return "";
    ...
    // 时间增减实现
    std::string DateTime::addHours(const std::string& dateTimeStr, const int hours, const char* fmt_in, const char* fmt_out) {
        std::tm tm = {};
    ...
    std::string DateTime::addMinutes(const std::string& dateTimeStr, const int minutes, const char* fmt_in, const char* fmt_out) {
        std::tm tm = {};
        std::istringstream ss(dateTimeStr);
        ss >> std::get_time(&tm, fmt_in);
        if (ss.fail()) return "";
    ...
    std::string DateTime::addSeconds(const std::string& dateTimeStr, const int seconds, const char* fmt_in, const char* fmt_out) {
        std::tm tm = {};
        std::istringstream ss(dateTimeStr);
        ss >> std::get_time(&tm, fmt_in);
        if (ss.fail()) return "";
