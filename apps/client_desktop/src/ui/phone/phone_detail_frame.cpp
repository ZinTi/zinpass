...
PhoneDetailFrame::PhoneDetailFrame(QFrame *parent) : QFrame(parent){
    this->phone_ = new zinpass::MobilePhone;
    setup_ui();
}
...
void PhoneDetailFrame::list_telecom_operators() const {
    ...
    zinpass::TelecomRPC telecom_rpc(zinpass::ChannelManager::instance().get_channel());
...
void PhoneDetailFrame::setup_ui(){
    ...
    lyt_form1_ = new QFormLayout;
    lyt_form2_ = new QFormLayout;
    lyt_form3_ = new QFormLayout;
...
void PhoneDetailFrame::fetch_phone_by_id(const int id) const {
    ...
    // 2. 查询数据
    zinpass::PhoneRPC phone_rpc(zinpass::ChannelManager::instance().get_channel());
...
zinpass::MobilePhone PhoneDetailFrame::get_phone() const{
    return *this->phone_;
}
