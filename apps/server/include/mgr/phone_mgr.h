...
public:
     ...
     */
    static Return<std::vector<zinpass::MobilePhone>> get_mobile_phones(const std::string& sys_user_id, const std::string& telecom_operator, const std::string& phone_number);
     ...
     */
    static Return<zinpass::MobilePhone> get_phone_by_owner_and_id(const std::string& sys_user_id, int phone_id);
     ...
     * @return phone + message
     */
    static Return<zinpass::MobilePhone> get_phone_by_id(int phone_id);
