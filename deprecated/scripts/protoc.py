...
def main():
    ...
    target_dir_service = os.path.join(PROJECT_ROOT, "service", "auto_gen")
    target_dir_control = os.path.join(PROJECT_ROOT, "control", "auto_gen")
    target_dir_client = os.path.join(PROJECT_ROOT, "client_desktop", "auto_gen", "grpc")
