...
public:
     ...
     * @return 成功与否
     */
    DaoStatus find_by_id(int id, zinpass::MobilePhone& mobile_phone) const;
     ...
     * @return 成功与否
     */
    DaoStatus find_by_number(const std::string& phone_number, zinpass::MobilePhone& mobile_phone) const;
     ...
     * @return 成功与否
     */
    [[nodiscard]] DaoStatus add(const zinpass::MobilePhone& mobile_phone) const;
    ...
    // [[nodiscard]] DaoStatus update(const zinpass::MobilePhone& mobile_phone) const;
...
private:
     ...
     * @return
     */
    static zinpass::MobilePhone MobilePhoneFromStatement(sqlite3_stmt* stmt);
