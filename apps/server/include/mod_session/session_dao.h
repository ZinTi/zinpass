...
public:
     ...
     * @return 执行结果
     */
    zinpass::DaoStatus find_by_id(const std::string& id, zinpass::Session&session) const;
     ...
     * @return 执行结果
     */
    zinpass::DaoStatus add(const zinpass::Session& session) const;
     ...
     * @return 执行结果
     */
    zinpass::DaoStatus update(const zinpass::Session& session) const;
     ...
     * @return 执行结果
     */
    zinpass::DaoStatus remove(const std::string &id) const;
     ...
     * @return 执行结果
     */
    zinpass::DaoStatus update_expiration(const std::string& id, const std::string& expires_date_time) const;

private:
    zinpass::ConnectionPool& pool_;
