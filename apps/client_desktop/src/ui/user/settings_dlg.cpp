...
void SettingsDlg::setup_ui() {
    ...
    const std::string ip_addr = zinpass::ClientConfig::instance().get_server_ipv4();
    const std::string port = std::to_string(zinpass::ClientConfig::instance().get_server_port());
