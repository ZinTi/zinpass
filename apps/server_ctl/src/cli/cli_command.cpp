...
void CliCommand::copyleft() {
    ...
    const zinpass::StatusRPC status_rpc(channel);
...
void CliCommand::help(){
    const std::string manual =
        ...
        "restart      " "restart the zinpassd.\n"
        "start        " "start the zinpassd.\n"
        "status       " "Print status.\n"
        "stop         " "Stop the zinpassd.\n"
        "shutdown     " "Shutdown the zinpassd. Same as `stop`.\n"
...
void CliCommand::start(){
    const std::string tips = "请手动启动 zinpassd";
