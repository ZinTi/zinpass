...
public:
     ...
     * @return 成功与否
     */
    DaoStatus findById(const std::string& id, zinpass::SystemUser& sys_user) const;
     ...
     * @return 成功与否
     */
    DaoStatus findByUsername(const std::string& username, zinpass::SystemUser& sys_user) const;
     ...
     * @return 成功与否
     */
    [[nodiscard]] DaoStatus add(const zinpass::SystemUser& sys_user) const;
     ...
     * @return 成功与否
     */
    [[nodiscard]] DaoStatus update(const zinpass::SystemUser& sys_user) const;
